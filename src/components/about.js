        ...
        <section id="about" className="about-wrapper">
              <div className="about offset">
                  ...
                  <div className="about-body"><p>Hello! I recently graduated from the University of North Carolina at Charlotte with a degree in computer science focusing in software engineering and a minor in mathematics. Take a look at my <a class="link" href= {resume }>Resumé</a>.
                        ...
                        <p>I am enthusiastic about learning web technologies and prepared to take on new challenges. When I am not coding you can find me spending my free time drawing or playing video games with friends.</p>
                        <p>You can also find me on <a class="link" href="https://www.linkedin.com/in/marisolsgarcia/">LinkedIn</a>, <a class="link" href="https://github.com/marsgs">Github</a>, and <a class="link" href="https://dribbble.com/marsgs">Dribbble</a>.</p>
                    </div>
              </div>
